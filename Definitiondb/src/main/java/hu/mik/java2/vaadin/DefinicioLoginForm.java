...
public class DefinicioLoginForm extends VerticalLayout {
	
	private Label errorLabel;
	
	public DefinicioLoginForm() {
		...
		this.errorLabel = new Label(String.format("<div style='color:red;'>%s</div>", "Wrong password or username"), ContentMode.HTML);
